...
const S = StyleSheet.create({
  page:        { paddingTop: 36, paddingBottom: 36, paddingLeft: 40, paddingRight: 40, fontFamily: 'Helvetica', fontSize: 9, color: '#1e293b' },
  header:      { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 24, paddingBottom: 16, borderBottomWidth: 1.5, borderBottomColor: '#1F3A93' },
  ...
  validBadge:  { backgroundColor: '#E65100', color: '#ffffff', paddingTop: 3, paddingBottom: 3, paddingLeft: 8, paddingRight: 8, borderRadius: 4, fontSize: 8, fontFamily: 'Helvetica-Bold', alignSelf: 'flex-start', marginBottom: 14 },
  twoCol:      { flexDirection: 'row', gap: 16, marginBottom: 16 },
  clientBox:   { flex: 1, backgroundColor: '#f0f4ff', borderRadius: 6, paddingTop: 12, paddingBottom: 12, paddingLeft: 14, paddingRight: 14 },
  summaryBox:  { width: 180, backgroundColor: '#f8fafc', borderRadius: 6, paddingTop: 12, paddingBottom: 12, paddingLeft: 14, paddingRight: 14 },
  ...
  tHead:       { flexDirection: 'row', backgroundColor: '#1F3A93', borderTopLeftRadius: 4, borderTopRightRadius: 4, borderBottomLeftRadius: 0, borderBottomRightRadius: 0, paddingTop: 6, paddingBottom: 6, paddingLeft: 10, paddingRight: 10 },
  tHeadCell:   { color: '#ffffff', fontFamily: 'Helvetica-Bold', fontSize: 8 },
  tRow:        { flexDirection: 'row', paddingTop: 8, paddingBottom: 8, paddingLeft: 10, paddingRight: 10, borderBottomWidth: 0.5, borderBottomColor: '#f1f5f9' },
  ...
  notesBox:    { backgroundColor: '#fffbeb', borderRadius: 6, paddingTop: 10, paddingBottom: 10, paddingLeft: 12, paddingRight: 12, marginBottom: 14, borderWidth: 0.5, borderColor: '#fcd34d', borderStyle: 'solid' },
  notesLabel:  { fontFamily: 'Helvetica-Bold', color: '#92400e', fontSize: 8, marginBottom: 4 },
  notesText:   { color: '#78350f', fontSize: 8 },
  terms:       { backgroundColor: '#f8fafc', borderRadius: 6, paddingTop: 10, paddingBottom: 10, paddingLeft: 12, paddingRight: 12, marginBottom: 14 },
  ...
  footer:      { position: 'absolute', bottom: 28, left: 40, right: 40, flexDirection: 'row', justifyContent: 'space-between', borderTopWidth: 0.5, borderTopColor: '#e2e8f0', paddingTop: 8 },
